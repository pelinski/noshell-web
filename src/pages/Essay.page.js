...
export const EssayPage = () => {
    ...
    return (<>
        ...
        <FootnotesProvider>
            ...
            <p>When Italo Calvino wrote ``A voice means this: there is a living person, throat, chest, feelings, who sends into the air this voice, different from all other voices.''\footnotemark , he was surely not thinking on virtual agents such as Siri or Alexa. Those agents with proper names have voices that for certain do not come from a living throat or chest, but are artificially synthesized instead. ``The voice without a body is inherently uncanny'', states Dolar in <i>A Voice and Nothing More</i> <a href='#Dolar2006'>[2]</a>, referring to the mother's voice in the movie Psycho (Alfred Hitchcock, 1960). How different is this uncanny in the voices that we assume come from a body and the artificial voices that we assume come from no body? How can indeed voices come from no body? Deep learning techniques train their voices making use of datasets of recorded human speech. Are the individuals that gave their voice to the dataset the body behind those voices? Current state of the art deep learning speech synthesizing technologies generate voices that sound breathing, moving, that bring us closer to forget about the artificial in the voice. If the `robotic' character of the sound is overcome, what is it that remains artificial in the voice?</p>
            <p>
