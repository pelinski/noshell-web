...
export const AboutMePage: React.FC = (): JSX.Element => (
	<div id='aboutme'>
		...
		<p>
			...
			my phd topic is in digital musical instruments. i like computers, books and languages.
			my website is <a href='https://teresapelinski.com'>www.teresapelinski.com</a> and if for
			whatever reason you want to send me an email you can do it at{' '}
